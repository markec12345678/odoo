...
class L10n_si_laundry_order (models.Model):
    _name = "l10n_si.laundry.order"
    _description = "Slovenian Laundry Service"
    ...
    def create(self, vals_list):
        for vals in vals_list:
            if vals.get("number","/") == "/":
                vals["number"] = self.env["ir.sequence"].next_by_code("l10n_si.laundry.order") or "/"
