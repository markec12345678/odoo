...
class L10n_si_gift_voucher (models.Model):
    _name = "l10n_si.gift.voucher"
    _description = "Slovenian Gift Voucher"
    ...
    def create(self, vals_list):
        for vals in vals_list:
            if vals.get("number","/") == "/":
                vals["number"] = self.env["ir.sequence"].next_by_code("l10n_si.gift.voucher") or "/"
