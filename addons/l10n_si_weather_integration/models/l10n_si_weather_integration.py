...
class L10n_si_weather_forecast (models.Model):
    _name = "l10n_si.weather.forecast"
    _description = "Slovenian Weather Integration"
    ...
    def create(self, vals_list):
        for vals in vals_list:
            if vals.get("number","/") == "/":
                vals["number"] = self.env["ir.sequence"].next_by_code("l10n_si.weather.forecast") or "/"
