...
class L10n_si_kitchen_display (models.Model):
    _name = "l10n_si.kitchen.display"
    _description = "Slovenian Kitchen Display"
    ...
    def create(self, vals_list):
        for vals in vals_list:
            if vals.get("number","/") == "/":
                vals["number"] = self.env["ir.sequence"].next_by_code("l10n_si.kitchen.display") or "/"
