...
class L10n_si_minibar_consumption (models.Model):
    _name = "l10n_si.minibar.consumption"
    _description = "Slovenian Hotel Minibar"
    ...
    def create(self, vals_list):
        for vals in vals_list:
            if vals.get("number","/") == "/":
                vals["number"] = self.env["ir.sequence"].next_by_code("l10n_si.minibar.consumption") or "/"
