...
class L10n_si_hotel_chain (models.Model):
    _name = "l10n_si.hotel.chain"
    _description = "Slovenian Multi-Company"
    ...
    def create(self, vals_list):
        for vals in vals_list:
            if vals.get("number","/") == "/":
                vals["number"] = self.env["ir.sequence"].next_by_code("l10n_si.hotel.chain") or "/"
